 ...
 * Created by Sourav
 */
public class CollectionLocation extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onLocationChanged(android.location.Location location) {
       ...
       /* for (int i=0;i<array_list.size();i++)
        {
           // Toast.makeText(this, "Length is"+array_list.size(), Toast.LENGTH_SHORT).show();
             GetSetValues getset = array_list.get(i);
             lati = getset.getLatitude();
            // Toast.makeText(this, "LATITUDE"+lati, Toast.LENGTH_SHORT).show();
             longi = getset.getLongitude();
            try {
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            {
                e.printStackTrace();
                Toast.makeText(CollectionLocation.this, "Please ckeck your internet connection!!", Toast.LENGTH_SHORT).show();
            }


            startAddress = DataParser.mMyAppsBundle.getString("startAddress");
            Toast.makeText(CollectionLocation.this, "Start Address.."+startAddress, Toast.LENGTH_SHORT).show();
            endAddress = DataParser.mMyAppsBundle.getString("endAddress");
            Toast.makeText(CollectionLocation.this, "End Address.."+endAddress, Toast.LENGTH_SHORT).show();
    ...
    public void onDirectionSuccess(Direction direction, String rawBody) {
        Toast.makeText(CollectionLocation.this, "Success with status : " + direction.getStatus(), Toast.LENGTH_SHORT).show();
        if (direction.isOK()) {
    ...
    public void onDirectionFailure(Throwable t) {
        Toast.makeText(CollectionLocation.this, t.getMessage(), Toast.LENGTH_SHORT).show();
    }
}
