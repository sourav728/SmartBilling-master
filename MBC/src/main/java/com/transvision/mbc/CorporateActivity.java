...
public class CorporateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initialize();
        for (int i = 0; i < getResources().getStringArray(R.array.corporate_values).length; i++) {
            getSetValues = new GetSetValues();
            getSetValues.setLogin_role(getResources().getStringArray(R.array.corporate_values)[i]);
        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        if (main_role.equals("CorpEE")||main_role.equals("CorpAEE")||main_role.equals("CorpAO")||main_role.equals("CorpTL"))
                        {
                            Intent intent = new Intent(CorporateActivity.this, MainActivity.class);
